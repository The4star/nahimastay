class AccommodationsController < ApplicationController
  ...
  private
    ...
    def accommodation_params
      params.require(:accommodation).permit(:date_created, :name, :description, :country, :city, :address, :user_id, :accommodation_rating, :available_start_date, :available_end_date, :accomtype_id)
    end
end
